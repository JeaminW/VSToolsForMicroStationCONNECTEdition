...
namespace VSTMC
{
    ...
    internal sealed class NativeImportCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeImportCommand"/> class.
        ...
        /// </summary>
        public static NativeImportCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in NativeImportCommand's constructor requires
            // the UI thread.
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            utilities.ImportNativeApps(this.package);
        }
    }
}
