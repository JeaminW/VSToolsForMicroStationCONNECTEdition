...
namespace VSTMC
{
    ...
    internal sealed class SearchBentleyForumsCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchBentleyForumsCommand"/> class.
        ...
        {
            // Switch to the main thread - the call to AddCommand in SearchBentleyForumsCommand's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync((typeof(IMenuCommandService))) as OleMenuCommandService;
            Instance = new SearchBentleyForumsCommand(package, commandService);
        }
